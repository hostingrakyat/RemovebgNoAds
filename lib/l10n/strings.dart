...
const Map<AppLang, Map<String, String>> _strings = {
  AppLang.en: {
    ...
    'downloading_model': 'Preparing offline model…',
    'downloading_model_sub': 'One-time download · needs internet · then offline forever',
    'model_ready': 'Offline model ready',
  ...
  AppLang.id: {
    ...
    'downloading_model': 'Menyiapkan model offline…',
    'downloading_model_sub': 'Unduh sekali · perlu internet · setelah itu offline selamanya',
    'model_ready': 'Model offline siap',
    'continue_anyway': 'Tetap lanjut',
